...
TEST(IEEEComplianceChecker, EdgeCases) {
    ...
    EXPECT_TRUE(IEEEComplianceChecker::is_finite(42));  // integers are always finite
    EXPECT_FALSE(IEEEComplianceChecker::is_nan(42));    // integers are never NaN
    EXPECT_FALSE(IEEEComplianceChecker::is_inf(42));    // integers are never infinite
}
