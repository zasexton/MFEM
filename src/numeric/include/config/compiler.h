...
// Compiler detection
  ...
  #define FEM_NUMERIC_COMPILER_VERSION (__clang_major__ * 10000 + \
                                        __clang_minor__ * 100 + \
  ...
  #define FEM_NUMERIC_COMPILER_VERSION (__GNUC__ * 10000 + \
                                        __GNUC_MINOR__ * 100 + \
                                        __GNUC_PATCHLEVEL__)
...
#elif defined(FEM_NUMERIC_COMPILER_GCC) && FEM_NUMERIC_COMPILER_VERSION >= 130000
...
#if FEM_NUMERIC_CPP_VERSION >= 2020 && FEM_NUMERIC_HAS_CPP_ATTRIBUTE(no_unique_address)
...
// Loop optimization hints
  ...
  #define FEM_NUMERIC_VECTORIZE_LOOP \
    FEM_NUMERIC_PRAGMA(GCC ivdep)
  #define FEM_NUMERIC_UNROLL_LOOP(n) \
    FEM_NUMERIC_PRAGMA(GCC unroll n)
  #define FEM_NUMERIC_NO_VECTORIZE \
    FEM_NUMERIC_PRAGMA(GCC novector)
#elif defined(FEM_NUMERIC_COMPILER_MSVC)
  #define FEM_NUMERIC_VECTORIZE_LOOP \
    FEM_NUMERIC_PRAGMA(loop(ivdep))
  #define FEM_NUMERIC_UNROLL_LOOP(n)
  #define FEM_NUMERIC_NO_VECTORIZE
#else
  #define FEM_NUMERIC_VECTORIZE_LOOP
...
// Diagnostic control
  ...
  #define FEM_NUMERIC_DIAGNOSTIC_PUSH \
    FEM_NUMERIC_PRAGMA(GCC diagnostic push)
  #define FEM_NUMERIC_DIAGNOSTIC_POP \
    FEM_NUMERIC_PRAGMA(GCC diagnostic pop)
  #define FEM_NUMERIC_DISABLE_WARNING(w) \
    FEM_NUMERIC_PRAGMA(GCC diagnostic ignored #w)
#elif defined(FEM_NUMERIC_COMPILER_CLANG)
  #define FEM_NUMERIC_DIAGNOSTIC_PUSH \
    FEM_NUMERIC_PRAGMA(clang diagnostic push)
  #define FEM_NUMERIC_DIAGNOSTIC_POP \
    FEM_NUMERIC_PRAGMA(clang diagnostic pop)
  #define FEM_NUMERIC_DISABLE_WARNING(w) \
    FEM_NUMERIC_PRAGMA(clang diagnostic ignored #w)
#elif defined(FEM_NUMERIC_COMPILER_MSVC)
  #define FEM_NUMERIC_DIAGNOSTIC_PUSH \
    FEM_NUMERIC_PRAGMA(warning(push))
  #define FEM_NUMERIC_DIAGNOSTIC_POP \
    FEM_NUMERIC_PRAGMA(warning(pop))
  #define FEM_NUMERIC_DISABLE_WARNING(w) \
    FEM_NUMERIC_PRAGMA(warning(disable: w))
#else
  #define FEM_NUMERIC_DIAGNOSTIC_PUSH
  #define FEM_NUMERIC_DIAGNOSTIC_POP
  #define FEM_NUMERIC_DISABLE_WARNING(w)
